...
<%@page import="br.ucsal.transporte.dao.MotoristaDao"%>
<%@page import="br.ucsal.transporte.model.Motorista"%>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well">
								<h2>
									<i class="glyphicon glyphicon-info-sign"></i>Cadastro Ônibus
								</h2>
							...
							<div class="box-content row">
								...
								<form class="formoid-solid-blue"
									...
									action="OnibusController" method="post">
									<div class="title">
										<h2>Cadastro Onibus</h2>
									</div>
									...
									<select name="idMotorista">
										...
										<%
											...
											List<Motorista> motoristas = dao.getAllMotorista();
											for (Motorista motorista : motoristas) {
										%>
										<option><%= motorista.getIdMotorista()%></option>
										<%
											}
										%>
									</select>
									...
									<div class="element-input">
										...
										<div class="item-cont">
											<input class="medium" type="text" name="placa"
												placeholder="Placa" required /><span class="icon-place"></span>
										</div>
									</div>
									<div class="element-input">
										<label class="title"></label>
										<div class="item-cont">
											<input class="medium" type="text" name="empresa"
												placeholder="Empresa" required /><span class="icon-place"></span>
										</div>
									</div>
									...
									<div class="element-input">
										<label class="title"></label>
										<div class="item-cont">
											<input class="large" type="text" name="anoFabricacao"
												placeholder="Ano Fabricacao" required /><span class="icon-place"></span>
										</div>
									</div>
									<div class="element-input">
										<label class="title"></label>
										<div class="item-cont">
											<input class="medium" type="text" name="quantidadeAssentos"
												placeholder="Numero de Assentos" required/><span class="icon-place"></span>
										</div>
									</div>
									<div class="submit">
