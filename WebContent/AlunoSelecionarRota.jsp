...
<body>
			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-header well">
						<h2>
							<i class="glyphicon glyphicon-info-sign"></i>Cadastro Motorista
						</h2>
   ...
   %>
						...
						<form class="formoid-solid-blue"
							...
							action="AlunoController" method="POST">
							<div class="title">
							...
							<select name="idRota">
								...
								<option><%=request.getAttribute("idRota")%></option>
								<%
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="large" type="text" name="nome"
										value="<%=request.getAttribute("nome") %>" placeholder="Nome" /><span
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="rg"
										value="<%=request.getAttribute("rg") %>" placeholder="Rg" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								<label class="title">Titulo de Eleitor</label>
								<div class="item-cont">
									<input class="medium" type="text" name="TituloEleitor"
										value="<%=request.getAttribute("titulo") %>"
										placeholder="Titulo de Eleitor" /><span class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="dataNascimento"
										...
										placeholder="Data Nascimento" /><span class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								<label class="title">Faculdade</label>
								<div class="item-cont">
									<input class="medium" type="text" name="faculdade"
										value="<%=request.getAttribute("faculdade") %>"
										placeholder="instituicao Ensino" /><span class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="turno"
										value="<%=request.getAttribute("turno") %>"
							...
							<div class="element-input">
								<label class="title">Endereco</label>
								<div class="item-cont">
									<input class="large" type="text" name="endereco"
										value="<%=request.getAttribute("endereco") %>"
										placeholder="Endereço" /><span class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="sexo"
										value="<%=request.getAttribute("sexo") %>" placeholder="sexo" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="estadoCivil"
										value="<%=request.getAttribute("estadocivil") %>"
