			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-header well">
						<h2>
							<i class="glyphicon glyphicon-info-sign"></i>Atualizar Rota
						</h2>
					...
					<div class="box-content row">
						...
						<form class="formoid-solid-blue"
							...
							action="RotaListaController" method="post">
							<div class="title">
								<h2>Atualizar Rota</h2>
							</div>

							<div class="element-input">
								<label class="title">Id Rota</label>
								<div class="item-cont">
									<input class="medium" type="text" name="idRota"
										value="<c:out value="${rota.idRota}"/>" /> <span
							...
							<div class="element-input">
								<label class="title">Nome da Rota</label>
								<div class="item-cont">
									<input class="medium" type="text" name="Nome"
										value="<c:out value="${rota.nome}"/>" /> <span
										class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="large" type="text" name="Turno"
										value="<c:out value="${rota.turno}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>

							<div class="element-input">
								<label class="title">Pontos de Parada</label>
								<div class="item-cont">
									<input class="large" type="text" name="Pontos_Parada"
										value="<c:out value="${rota.pontosParada}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="Placa_Onibus"
										value="<c:out value="${rota.placaOnibus}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
