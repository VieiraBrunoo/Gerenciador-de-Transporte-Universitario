...
<!--
    ...
    -->
<meta charset="utf-8">
<title>Onibus Cadastrados</title>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							...
							<table
								...
								<tbody>
									<c:forEach items="${onibus}" var="onibus">
										<tr>


											<td class="center"><c:out value="${onibus.empresa}" /></td>
											<td class="center"><c:out value="${onibus.placa}" /></td>
											<td class="center"><c:out
													value="${onibus.anoFabricacao}" /></td>
											<td class="center"><c:out
													value="${onibus.quantidadeAssentos}" /></td>
											<td class="center"><c:out value="${onibus.idMotorista}" /></td>

											<td class="center"><a class="btn btn-info"
												href="OnibusListaController?action=editar&placa=<c:out value="${onibus.placa}"/>">
													<i class="glyphicon glyphicon-edit icon-white"></i> Editar
											</a> <a class="btn btn-danger"
												href="OnibusListaController?action=delete&placa=<c:out value="${onibus.placa }"/>">
