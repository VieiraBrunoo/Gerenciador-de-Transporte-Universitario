			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-header well">
						<h2>
							<i class="glyphicon glyphicon-info-sign"></i>Atualizar Onibus
						</h2>
					...
					<div class="box-content row">
						...
						<form class="formoid-solid-blue"
							...
							action="OnibusListaController" method="post">
							<div class="title">
								<h2>Atualizar Onibus</h2>
							</div>
							<div class="element-input">
								<label class="title">Placa do Onibus</label>
								<div class="item-cont">
									<input class="medium" type="text" name="placa"
										value="<c:out value="${onibus.placa}"/>" /> <span
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="large" type="text" name="empresa"
										value="<c:out value="${onibus.empresa}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								<label class="title">Ano Fabricacao</label>
								<div class="item-cont">
									<input class="medium" type="text" name="anoFabricacao"
										value="<c:out value="${onibus.anoFabricacao}"/>"
										placeholder="Numero Habilitação" /><span class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								<label class="title">Quantidade de Assentos</label>
								<div class="item-cont">
									<input class="medium" type="text" name="quantidadeAssentos"
										value="<c:out value="${onibus.quantidadeAssentos}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>

							<div class="element-input">
								<label class="title">Matricula Motorista</label>
								<div class="item-cont">
									<input class="large" type="text" name="idMotorista"
										value="<c:out value="${onibus.idMotorista}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
