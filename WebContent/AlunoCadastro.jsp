...
<%@page import="br.ucsal.transporte.dao.AlunoDao"%>
<%@page import="br.ucsal.transporte.model.Aluno"%>
<%@page import="br.ucsal.transporte.model.Rota"%>
...
<script type="text/javascript"
	src="motorista_files/formoid1/jquery.min.js">
			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-header well">
						<h2>
							<i class="glyphicon glyphicon-info-sign"></i>Cadastro Aluno
						</h2>
					...
					<div class="box-content row">
						...
						<form class="formoid-solid-blue"
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="large" type="text" name="nome" placeholder="Nome" required /><span
							...
							<div class="element-input">
								<label class="title"></label>
								<div class="item-cont">
									<input class="medium" type="text" name="rg" placeholder="Rg" required /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								<label class="title"></label>
								<div class="item-cont">
									<input class="medium" type="text" name="TituloEleitor"
										placeholder="Titulo de Eleitor" required/><span class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-date">
								...
								<div class="item-cont">
									<input class="large" data-format="dd-mm-yyyy" type="date"
										name="dataNascimento" placeholder="Data Nascimento" required/><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="telefone"
										placeholder="Telefone" required /><span class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								<label class="title"></label>
								<div class="item-cont">
									<input class="medium" type="text" name="faculdade"
										placeholder="instituicao Ensino" required /><span class="icon-place"></span>
								</div>
							</div>
                             ...
                             <div class="element-radio">
								...
								<div class="column column2">
									<label><input type="radio" name="Turno"
										value="Matutino" /><span>Matutino</span></label>
									</label> <label> <input type="radio" name="Turno"
										value="Noturno" /><span>Noturno </span>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="large" type="text" name="endereco"
										placeholder="Endereço" required/><span class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								<label class="title"></label>
								<div class="item-cont">
									<input class="medium" type="text" name="bairro"
										placeholder="Bairro" required /><span class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								<label class="title"></label>
								<div class="item-cont">
									<input class="medium" type="text" name="cidade"
										placeholder="Cidade" required /><span class="icon-place"></span>
								</div>
							</div>
							<div class="element-radio">
								...
								<div class="column column2">
									<label><input type="radio" name="sexo"
										value="Masculino" /><span>Masculino</span></label>
								</div>
								<span class="clearfix"></span>
								<div class="column column2">
									<label><input type="radio" name="sexo" value="Feminino" /><span>Feminino</span></label>
								</div>
								<span class="clearfix"></span>
							</div>
							...
							<div class="element-radio">
								...
								<div class="column column2">
									<label><input type="radio" name="estadocivil"
										value="Solteiro (a)" /><span>Solteiro (a)</span></label><label><input
										type="radio" name="estadocivil" value="Divorciado (a)" /><span>Divorciado
											(a)</span></label>
								</div>
								<span class="clearfix"></span>
								<div class="column column2">
									<label><input type="radio" name="estadocivil"
										value="Casado (a)" /><span>Casado (a)</span></label><label><input
										type="radio" name="estadocivil" value="Viúvo (a)" /><span>Viúvo
											(a)</span></label>
								</div>
								<span class="clearfix"></span>
							</div>
							...
							<div class="submit">
								<input type="submit" name="proximo" value="Cadastrar" />
							</div>
					</div>
