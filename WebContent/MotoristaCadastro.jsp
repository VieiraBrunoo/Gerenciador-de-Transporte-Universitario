				...
				<div class="box-inner">
					...
					<div class="box-content row">
						...
						<form class="formoid-solid-blue"
							...
							action="MotoristaController" method="post">
							<div class="title">
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="numeroHabilitacao"
										placeholder="Numero Habilitação" required /><span class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								<label class="title"></label>
							...
							<div class="element-radio">
								...
								<div class="column column2">
									<label><input type="radio" name="sexo"
										value="Masculino" required/><span>Masculino</span></label>
								</div>
							...
							<div class="element-input">
								<label class="title"></label>
								<div class="item-cont">
									<input class="medium" type="text" name="cpf" placeholder="CPF" required /><span
										class="icon-place"></span>
								</div>
							</div>
							<div class="element-radio">
