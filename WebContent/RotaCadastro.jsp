...
<%@page import="br.ucsal.transporte.dao.OnibusDao"%>
<%@page import="br.ucsal.transporte.model.Onibus"%>
			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-header well">
						<h2>
							<i class="glyphicon glyphicon-info-sign"></i>Cadastro de Rota
						</h2>
					...
					<div class="box-content row">
						...
						<form class="formoid-solid-blue"
							...
							action="RotaController" method="post">
							<div class="title">
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="Nome"
										placeholder="Nome Rota" required /><span class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="large" type="text" name="Pontos_Parada"
										placeholder="Pontos de Parada" required /><span class="icon-place"></span>
								</div>
							</div>



							<select name="Placa_Onibus">
								<option>Selecione a Placa do Onibus</option>
								<%
											OnibusDao dao = new OnibusDao();
											List<Onibus> onibus = dao.getAllOnibus();
											for (Onibus bus : onibus) {
										%>
								<option><%= bus.getPlaca()%></option>
								<%
											}
										%>
							</select>
