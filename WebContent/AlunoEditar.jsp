...
<body>
			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-header well">
						<h2>
							<i class="glyphicon glyphicon-info-sign"></i> Atualizar Aluno
						</h2>
   ...
   %>
						...
						<form class="formoid-solid-blue"
							...
							action="AlunoListaController" method="POST">
							<div class="title">
								<h2>Cadastro Aluno</h2>
							</div>

							<div class="element-input">
								<label class="title">Id Aluno</label>
								<div class="item-cont">
									<input class="large" type="text" name="idAluno"
										value="<c:out value="${aluno.idAluno}"/>" /><span
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="large" type="text" name="nome"
										value="<c:out value="${aluno.nome}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="rg"
										value="<c:out value="${aluno.rg}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="TituloEleitor"
										value="<c:out value="${aluno.tituloEleitor}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="dataNascimento"
										value="<c:out value="${aluno.dataNascimento}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="telefone"
										value="<c:out value="${aluno.telefone}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="large" type="text" name="endereco"
										value="<c:out value="${aluno.endereco}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="bairro"
										value="<c:out value="${aluno.bairro}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="cidade"
										value="<c:out value="${aluno.cidade}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="sexo"
										value="<c:out value="${aluno.sexo}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
							...
							<div class="element-input">
								...
								<div class="item-cont">
									<input class="medium" type="text" name="estadoCivil"
										value="<c:out value="${aluno.estadoCivil}"/>" /><span
										class="icon-place"></span>
								</div>
							</div>
