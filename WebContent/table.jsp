...
<meta charset="utf-8">
<title>Motorista Cadastrados</title>
			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-header well" data-original-title="">
						<h2>
							<i class="glyphicon glyphicon-user"></i> Motoristas Cadastrados
						</h2>
						...
						<tbody>
							<c:forEach items="${motoristas}" var="motorista">
								<tr>
									...
									<td class="center"><c:out value="${motorista.idMotorista}" /></td>
									<td class="center"><c:out value="${motorista.nome}" /></td>
									<td class="center"><c:out value="${motorista.habilitacao}" /></td>
									<td class="center"><c:out value="${motorista.telefone}" /></td>
									<td class="center"><c:out value="${motorista.endereco}" /></td>
									<td class="center"><c:out value="${motorista.bairro}" /></td>
									<td class="center"><c:out value="${motorista.cidade}" /></td>
									<td class="center"><c:out value="${motorista.sexo}" /></td>
									<td class="center"><c:out value="${motorista.cpf}" /></td>
									<td class="center"><c:out value="${motorista.estadoCivil}" /></td>
									<td class="center"><c:out
											value="${motorista.dataNascimento}" /></td>

									<td class="center"><a class="btn btn-info"
										href="MotoristaListaController?action=editar&idMotorista=<c:out value="${motorista.idMotorista }"/>">
											<i class="glyphicon glyphicon-edit icon-white"></i> Editar
									</a> <a class="btn btn-danger"
										href="MotoristaListaController?action=delete&idMotorista=<c:out value="${motorista.idMotorista }"/>">
