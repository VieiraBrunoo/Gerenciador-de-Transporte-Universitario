...
<!--
    ...
    -->
<meta charset="utf-8">
<title>Rotas Cadastradass</title>
					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i> Rotas Cadastradas
								</h2>
								...
								<tbody>
									<c:forEach items="${rotas}" var="rota">
										<tr>
											...
											<td class="center"><c:out value="${rota.idRota}" /></td>
											<td class="center"><c:out value="${rota.nome}" /></td>
											<td class="center"><c:out value="${rota.turno}" /></td>
											<td class="center"><c:out value="${rota.pontosParada}" /></td>
											<td class="center"><c:out value="${rota.placaOnibus}" /></td>

											<td class="center"><a class="btn btn-info"
												href="RotaListaController.rl?action=editar&idRota=<c:out value="${rota.idRota}"/>">
													<i class="glyphicon glyphicon-edit icon-white"></i> Editar
											</a> <a class="btn btn-danger"
												href="RotaListaController.rl?action=delete&idRota=<c:out value="${rota.idRota}"/>">
